#Coding by Khan 
#Khan Brother team ( KBT ) 
# Author  : Khan Vau 
# Github  : https://github.com/khanbrother420
# Language: Python(3)
# Date    : 27-04-2023
...
def about():
    os.system("clear")
    sprint(logo, 0.01)
    print(f"{cyan}[ToolName]  {purple} :[KHAN]")
    print(f"{cyan}[Version]   {purple} :[2.0]")
    print(f"{cyan}[Author]    {purple} :[Mr.KhanVau]")
    print(f"{cyan}[Github]    {purple} :[https://github.com/khanbrother420]")
    print(f"{cyan}[Messenger] {purple} :[https://m.me/Mr.KhanVau420]")
    print(f"{cyan}[Email]     {purple} :[mrkhan991133@gmail.com]\n")
...
def main():
    os.system("clear")
    sprint(logo, 0.01)
    print(f"{green}[1]{purple} Encrypt{yellow} Bash")
    print(f"{green}[2]{purple} Decrypt{yellow} Bash")
    print(f"{green}[3]{purple} Encrypt{yellow} Python into Variable")
    print(f"{green}[4]{purple} Encrypt{yellow} Python into Emoji")
    print(f"{green}[5]{purple} More Tools")
    print(f"{green}[6]{purple} About")
    print(f"{green}[0]{purple} Exit")
